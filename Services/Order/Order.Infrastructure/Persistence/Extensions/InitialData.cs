    ...
    public static IEnumerable<SalesOrder> OrdersWithItems
    {
        get
        {
            ...
            order1
                ...
                .AddOrderItem(ProductId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")),"IphoneX", 2, 500)
                .AddOrderItem(ProductId.Of(new Guid("c67d6323-e8b1-4bdf-9a75-b0d0d2e7e914")), "Samsung 10", 1, 400);
            ...
            order2  
                ...
                .AddOrderItem(ProductId.Of(new Guid("4f136e9f-ff8c-4c1f-9a33-d12f689bdab8")), "IphoneX", 1, 650)
                .AddOrderItem(ProductId.Of(new Guid("6ec1297b-ec0a-4aa1-be25-6726e3b51a27")),"Samsung 10", 2, 450);
